...
public final class ViewAnimationUtils {
     ...
     * @param duration 持续时间
     */
    public static void translationX(View view, float fromX, float toX, int duration){
        ObjectAnimator
     ...
     * 点赞动画
     */
    public static void thumb(View v){
        ObjectAnimator.ofFloat(v, "scaleX", v.getScaleX() , v.getScaleX() + 1, v.getScaleX())
                .setDuration(500)
                .start();

        ObjectAnimator.ofFloat(v, "scaleY", v.getScaleY() , v.getScaleY() + 1, v.getScaleY())
                .setDuration(500)
                .start();
    }
}
